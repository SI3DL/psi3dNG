...
!-------------------------------------------------------------------------
   ...
   REAL, ALLOCATABLE, DIMENSION(:,:) :: Av, Dv,Dvm !Andrea Ptrack
   ...
   REAL   ,ALLOCATABLE, DIMENSION(:,:)::  uhNGB, uhNGBp, &
                                       &  vhNGB, vhNGBp, &
                                       &  scNGB, scNGBp, sNGB, sNGBp, sNGBpp, &
                                       &  huNGB, huNGBp, hvNGB, hvNGBp, &
                                       &  agNGB, agNGBp, arNGB, arNGBp
   ...
   INTEGER, PARAMETER :: max_planes = 10, max_sections = 30, max_isot = 10
...
!        -------- particle trakcing output *****************************************
   INTEGER :: n_ptrack   ! abh 2013, Dec 16
   INTEGER :: ptr        ! abh 2013, Dec 16
