...
omp:
	ifort -qopenmp -qopenmp-link=static -module $(MODDIR) -I/$(INCDIR) si3d_types.f90 si3d_utils.f90 si3d_boundaryconditions.f90 si3d_mixing.f90 si3d_procedures.f90 si3d.f90 -c
